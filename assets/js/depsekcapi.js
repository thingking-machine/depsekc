...
self.onmessage = async function(event) {
    ...
    try {
        ...
        try {
            ...
            const instructionResponse = await fetch('https://localhost/' + machineConfig.instruction_file);
            if (!instructionResponse.ok) {
                 ...
                 instructionText = "I am an assistant by the name 'Thingking-Machine'.";
            } else {
            ...
            instructionText = "I am an assistant by the name 'Thingking-Machine'."; // Default instruction on any fetch error
        }
